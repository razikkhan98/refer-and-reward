...
//                 <div
//                   className={` text-start ${isVisible ? 'plnt-animt-up' : 'plnt-animt-down'}`}
//                 >
//                   <img
...
//                 <div
//                   className={` text-end ${isVisible ? 'plnt-animt-up' : 'plnt-animt-down'}`}
//                 >
//                   <img
...
// <div className="center-section pt-5">
//   <h1>heading</h1>
//   </div>
// {/* footer section */}
// <div className="footer-section mt-5 pt-5">
//   <img className="h-25" src="https://picsum.photos/200/300" alt="" />
// </div>
...
import Howitworksfirst from './HowItWorks/howitworkfirst';
  ...
  return (
    <>
      ...
      >
        ...
        {/* Top Starts images */}
        <div
          className={`top-section  asto-transition-all duration-1000 w-100 position-absolute ${
        ...
        {/* middle section */}
        <div
          className={`container center-section  transition-all duration-1000 ${
            animateMiddle ? 'form-fade-down' : ''
          }`}
        >
          <div className="row text-center justify-content-center align-items-start h-100">
            <div className="col-12 col-md-5 content-z-index pt-72">
              ...
              <button onClick={handleClick} className="btn-share-via-whatsapp poppins-regular text-white bg-primary-color font-18 mb-46">
                Share Via Whatsapp
              </button>
        ...
        {/* footer section */}
        <div
          className={`footer-section asto-transition-all duration-1000 position-absolute w-100 bottom-0 ${
      ...
      {/* <section className={`invite-bg-image bg-transparent  ${animate ? 'zoom-in-up' : ''}`}> */}
        <Howitworksfirst />
        {/* <Howitworks /> */}
      {/* </section> */}
    </>

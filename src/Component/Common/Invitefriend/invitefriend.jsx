...
//       setTimeout(() => {
//         if (typeof onAnimationComplete === 'function') {
//           onAnimationComplete(); // go to next section
//         }
...
//       setTimeout(() => {
//         if (typeof onAnimationComplete === 'function') {
//           onAnimationComplete('reverse'); // custom flag if needed
//         }
...
//   // Handle scroll trigger animation (forward/backward)
//   useEffect(() => {
//     const handleWheel = (e) => {
//       if (!isActive || animationTriggered.current) return;
